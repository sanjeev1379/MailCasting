...
<div id="main">
	...
	Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","SYSTEM","system");
			...
			out.print("<br /><br />");
			out.print("<table border=8 bordercolor='#33CCFF'>");
			out.print("<tr><td>SENDER</td><th>MESSAGE</td><td>DATE OF RECIEVING</td><td>Delete</td></tr>");
			while(rs.next()){
				int id=rs.getInt(1);
				System.out.print(id);
				out.print("<tr>");
				out.print("<td width='45%'>" + rs.getString(3) + "</td>");
				out.print("<td width='90%'>" + rs.getString(4) + "</td>");
				out.print("<td width='70%'>" + rs.getString(5) + "</td>");
				//out.print("<td>" + rs.getString(4) + "</td>");
				//out.print("<td>" DeleteServlet.Del`"</td>");
				out.print("<td width='40%'><a href='delete.jsp?val="+rs.getInt(1)+"'> Delete</a></td>");
